...
class Palette {
  ...
  static const Color successDefStrong = Color(0xFF28A838);
  static const Color successBgStrong = Color(0xFFE3FCD8);
  ...
  static const Color body = Color(0xFF141A51);
  static const Color background = Color(0xFFF6F8FF);
  static const Color grey = Color(0xFF6974AA);
  static const Color placeholder = Color(0xFFB0BBE5);
  static const Color outline = Color(0xFFE7ECFA);
  static const Color disabled = Color(0xFFF4F7FF);
}
